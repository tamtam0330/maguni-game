...
const insertWord = ()=>{
    return axios({
        method: "POST",
        url: "http://13.124.180.166:3001/member/api/v1/word",
        data: {
            "roomCode": roomcode,
            "nickname": username,
            "word": inputValue
...
const getWords = ()=>{
    return axios({
        method: "GET",
        url: `http://13.124.180.166:3001/member/api/v1/word/${roomcode}/${username}`,
    }).then((res)=>{
...
const getPlayersInfo = ()=>{
    return axios({
        method: "GET",
        url: `http://13.124.180.166:3001/member/api/v1/word/${roomcode}`,
    }).then((res)=>{
